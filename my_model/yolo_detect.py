...
while True:
    ...
    for i in range(len(detections)):
        ...
        # Calcular las coordenadas del centro del bounding box
        centerX = int((xmin + xmax) / 2)
        centerY = int((ymin + ymax) / 2)

        # Opcional: Dibujar un círculo en el centro del objeto detectado
        cv2.circle(frame, (centerX, centerY), 5, (0, 0, 255), -1) # Dibuja un punto rojo
